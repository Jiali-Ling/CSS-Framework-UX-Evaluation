...
// Listen for the DOMContentLoaded event to ensure that the theme toggle button is available in the DOM before attaching the event listener. 
// This allows users to switch themes without delay once the page has fully loaded.
